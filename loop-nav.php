...
?>
	...
	<?php elseif ( !is_singular() && $nav = get_posts_nav_link( array( 'sep' => '', 'prelabel' => '<span class="previous">' . __( '<span class="meta-nav">&larr;</span> Previous', 'path' ) . '</span>', 'nxtlabel' => '<span class="next">' . __( 'Next &rarr;', 'path' ) . '</span>' ) ) ) : ?>
